...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print("\nValor inválido. O depósito deve ser um valor maior que 0")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        print("\nNão é possível sacar o dinheiro, ausência de saldo.")

    elif excedeu_limite:
        print("\nO valor do saque excede o limite permitido por saque (R$ 500,00).")
